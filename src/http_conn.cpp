...
bool http_conn::add_timer(mytimer* mtimer)
{
    if(m_timer == NULL)
    {
        m_timer = mtimer;
...
mytimer::mytimer(http_conn* _http_conn,int timeout)
{
    _http_conn = _http_conn;
    struct timeval now;
...
bool mytimer::isvalid()
{
    ...
    int cur_time = (tv.tv_sec*1000)+(tv.tv_usec/1000);
